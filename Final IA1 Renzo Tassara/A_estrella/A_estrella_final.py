...
filas = 12
columnas = 12
#obstaculos = [(2,1),(2,2),(2,3),(2,4),(2,6),(2,7),(2,8),(2,9),(2,10),(2,11),(4,1),(4,2),(4,3),(4,4),(4,6),(4,7),(4,8),(4,9),(4,10),(4,11),(6,1),(6,2),(6,3),(6,4),(6,6),(6,7),(6,8),(6,9),(6,10),(6,11),(8,1),(8,2),(8,3),(8,4),(8,6),(8,7),(8,8),(8,9),(8,10),(8,11),(10,1),(10,2),(10,3),(10,4),(10,6),(10,7),(10,8),(10,9),(10,10),(10,11)]
obstaculos = [(2,1),(2,2),(2,3),(2,4),(2,6),(2,7),(2,8),(2,9),(2,10),(2,11),(4,0),(4,1),(4,2),(4,3),(4,4),(4,5),(4,6),(4,7),(4,8),(4,9),(4,10),(4,11),(6,1),(6,2),(6,3),(6,4),(6,6),(6,7),(6,8),(6,9),(6,10),(6,11),(8,1),(8,2),(8,3),(8,4),(8,6),(8,7),(8,8),(8,9),(8,10),(8,11),(10,1),(10,2),(10,3),(10,4),(10,6),(10,7),(10,8),(10,9),(10,10),(10,11)]
tablero = Tablero(filas, columnas, obstaculos)  # Creamos el tablero
inicio1 = Nodo(2, 1)  # Nodo de inicio  ---> colocar (fila,columna) de obstaculo
objetivo1 = Nodo(10, 11)  # Nodo objetivo


##======== Modificacion de inicio y final de recorridos =========
if (inicio1.x,inicio1.y) in obstaculos:
        inicio1 = Nodo(inicio1.x - 1, inicio1.y)
else:
...
if (objetivo1.x,objetivo1.y) in obstaculos:
        objetivo1 = Nodo(objetivo1.x-1 , objetivo1.y - 1)
else:
...
for fila in range(tablero.filas):
    for columna in range(tablero.columnas):
        ...
        pygame.draw.rect(ventana, NEGRO, (columna * 60 + 60 // 2 - 30, fila * 60 + 60 // 2 - 30, 60, 60), 1)
